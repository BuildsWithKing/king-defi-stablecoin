...
- [Low Issues](#low-issues)
  ...
  - [L-6: Storage Array Length not Cached](#l-6-storage-array-length-not-cached)
...
| Filepath | nSLOC |
| --- | --- |
| src/KUSDEngine.sol | 261 |
| src/Utils/KingSafeERC20.sol | 19 |
| src/interfaces/IKUSDEngine.sol | 33 |
...
- Found in src/KUSDEngine.sol [Line: 461](src/KUSDEngine.sol#L461)

	```solidity
	    function getAccountInformation(address user)
	```

- Found in src/KUSDEngine.sol [Line: 474](src/KUSDEngine.sol#L474)
...
- Found in src/KUSDEngine.sol [Line: 410](src/KUSDEngine.sol#L410)
...
## L-6: Storage Array Length not Cached
...
- Found in src/KUSDEngine.sol [Line: 267](src/KUSDEngine.sol#L267)

	```solidity
	    function mintKUSD(uint256 amount) public nonReentrant validateAmount(amount) {
	```

- Found in src/KUSDEngine.sol [Line: 302](src/KUSDEngine.sol#L302)
